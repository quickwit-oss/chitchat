...
mod tests {
    ...
    fn test_chitchat_listener() {
        ...
        let mut node1 = Chitchat::with_chitchat_id_and_seeds(
            ...
            empty_seeds.clone(),
            vec![
                ("self1:suffix1".to_string(), "hello1".to_string()),
            ],
        );
        ...
        node1.subscribe_event("self1:", move |key, value | {
        ...
        node1.subscribe_event("other:", move |key, value| {
        ...
        let counter_self_key_clone = counter_self_key.clone();
        node1.subscribe_event("self2:", move |key, value| {
        ...
        let mut node2 = Chitchat::with_chitchat_id_and_seeds(
            ...
            empty_seeds,
            vec![
                ("other:suffix".to_string(), "hello".to_string()),
            ],
        );
